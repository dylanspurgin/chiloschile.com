    ...
    <section class="site-content boxed header-padding">
        <section class="content-row content-padding">
            ...
            <p>If you are not completely satisfied with a Chilo's Chile order,
                ...
                for the original amount.</p>
            <p>To inquire about a return please send us a message via our
            ...
            <p>All of the information collected via this web site is used
                ...
                organization for any purposes or reasons whatsoever.</p>
            <p>If at any time you no longer wish to receive emails or wish to
            ...
            <p>It is understood and agreed that seller's liability and
                ...
                in limiting seller's liability and purchaser's remedy.</p>
            <p>Seller will not be liable for any damages, losses or expenses as
